...
//
//DIVs:  for human confirmation of formulatic and variable accuracy
rect(divX, divY, divWidth, divHeight); ////Group of variables
//
//Library of Symbols, requires DIVs
rect(stopX, stopY, stopWidth, stopeight);
//triangle(playX1, playY1, playX2, playY2, playX3, playY3); //Group of Varibles; //Group of Variables
...
triangle(loopinfiniteX1,loopInfiniteY1, loopinfiniteX2, loopinfiniteY2,  loopinfiniteX1)
//Note: Loop infinit button same as loop onc, without text "1"square(loopinsquare(loopInfiniteStrNumX, loopinfiniteStrNumY, loopfiniteStrNumDimension);
square(loopOnceStrNumX, loopOnceStrNumY, loopOnceStrNumDimension);
triangle(fastFowardX1, fast
